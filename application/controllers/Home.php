...
class Home extends CI_Controller {
	...
	{
		$page = $_GET['page'];
		$umum = $this->mhome->getUmum($page);
		echo json_encode($umum);
	}

	public function getPilihanRedaksi()
	{
		$page = $_GET['page'];
		$pilihanRedaksi = $this->mhome->getPilihanRedaksi($page);
		echo json_encode($pilihanRedaksi);
	}

	public function getSpecial()
	{
		$page = $_GET['page'];
		$special = $this->mhome->getSpecial($page);
		echo json_encode($special);
	}

	public function getIndeksBerita()
	{
		$page = $_GET['page'];
		$indeksBerita = $this->mhome->getIndeksBerita($page);
		echo json_encode($indeksBerita);
	}
